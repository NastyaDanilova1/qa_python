...
class TestBooksCollector:
    ...
    @pytest.mark.parametrize('name', ['', 'Легенды о короле Артуре и рыцарях Круглого Стола'])
    ...
    def test_add_new_book_with_no_name_not_added(self, books_collector):
        name = ''
        books_collector.add_new_book(name)
    ...
    def test_get_books_for_children_return_non_rating_books(self, books_collector, add_books, set_genre):
        expected_books = ['Властелин колец - Две башни', 'Синий трактор', 'Дневник Бриджит Джонс']
    ...
    def test_add_book_in_favorites_not_added_book_twice_in_favorite_book(self, books_collector):
    ...
    def test_delete_book_from_favorites_not_deleted_book_if_book_not_in_favorite_books(self, books_collector):
        books_collector.add_new_book('Дневник Бриджит Джонс')
    ...
    def test_get_list_of_favorites_books_returned_list(self, books_collector, add_books):
